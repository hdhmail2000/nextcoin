...
public class C2CSellFragment extends BaseListFragment<C2CTransactionListEntity> {
    ...
    public void onRequest(int page) {
        if (mC2CCoinType == null) {
            ...
            Api.getInstance().fetchC2CSellList(page, mC2CCoinType.getId(), new Callback<C2cTransactionEntity>() {
                @Override
    ...
    public int getItemLayoutResId() {
        return R.layout.item_c2c_sell_fragment;
    }
    ...
    public void onBindView(ViewHolder holder, final C2CTransactionListEntity entity, int position) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                C2CSellActivity.openActivity((BaseActivity) getContext(), C2CSellActivity.class, bundle);
            }
        });
    }
