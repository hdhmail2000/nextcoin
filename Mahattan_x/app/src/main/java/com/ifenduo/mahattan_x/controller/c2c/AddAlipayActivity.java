...
public class AddAlipayActivity extends BaseActivity implements EasyPermissions.PermissionCallbacks {
    ...
    protected int getContentViewLayoutId() {
        return R.layout.activity_add_c2c_alipay;
    }
    ...
    private void submitAccount() {
        ...
        showProgress();
        Api.getInstance().submitAddAlipay(user.getFid(), name, account, mQRPath, new Callback<BaseEntity>() {
            @Override
    ...
    private void uploadQR(LocalMedia localMedia) {
        ...
        Api.getInstance().ossUploadImage(path, new Callback<String>() {
            ...
            public void onComplete(boolean isSuccess, int code, String msg, DataResponse<String> response) {
                ...
                PictureFileUtils.deleteCacheDirFile(AddAlipayActivity.this);
                setSubmitButtonEnable();
            }
        });
    }
