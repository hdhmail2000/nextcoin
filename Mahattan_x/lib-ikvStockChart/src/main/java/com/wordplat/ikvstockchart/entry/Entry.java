...
public class Entry {
    ...
    public Entry(float open, float high, float low, float close, float volume, String xLabel, String xLabel_) {
        this.open = open;
        this.high = high;
        this.low = low;
        this.close = close;
    ...
    public String getxLabel_() {
        if(TextUtils.isEmpty(xLabel_)){
            return xLabel;
        }
        return xLabel_;
    }
