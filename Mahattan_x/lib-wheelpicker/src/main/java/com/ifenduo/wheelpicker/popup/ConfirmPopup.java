package com.ifenduo.wheelpicker.popup;
...
import com.ifenduo.wheelpicker.R;
import com.ifenduo.wheelpicker.util.ConvertUtils;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected int cancelDrawable,submitDrawable;
    private TextView cancelButton, submitButton;
    private ImageView cancelImageButton,submitImageButton;
    private View titleView;
    private View headerView,footerView;

    private boolean isShowCancelImageButton,isShowSubmitImageButton;
    ...
    public void setShowCancelImageButton(boolean showCancelImageButton) {
        isShowCancelImageButton = showCancelImageButton;
    }

    public void setShowSubmitImageButton(boolean showSubmitImageButton) {
        isShowSubmitImageButton = showSubmitImageButton;
    }
     ...
     * @param drawableRes
     */
    public void setCancelImage(@DrawableRes int drawableRes){
        if (null != cancelImageButton) {
            cancelImageButton.setImageResource(drawableRes);
        } else {
            this.cancelDrawable = drawableRes;
        }
    }
     ...
     * @param drawableRes
     */
    public void setSubmitImage(@DrawableRes int drawableRes){
        if (null != submitImageButton) {
            submitImageButton.setImageResource(drawableRes);
        } else {
            this.submitDrawable = drawableRes;
        }
    }
    ...
    protected View makeHeaderView() {
        ...
        if(!isShowCancelImageButton){
            ...
            cancelImageButton=new ImageView(activity);
            cancelImageButton.setVisibility(cancelVisible ? View.VISIBLE : View.GONE);
            cancelImageButton.setLayoutParams(cancelParams);
            cancelImageButton.setBackgroundColor(Color.TRANSPARENT);
            cancelImageButton.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            cancelImageButton.setPadding(padding, 0, padding, 0);
            if (cancelDrawable!=0) {
                cancelImageButton.setImageResource(cancelDrawable);
            }else {
                cancelImageButton.setImageResource(R.drawable.icon_cancel);
            }
            ...
            topButtonLayout.addView(cancelImageButton);
        }
        ...
        if(!isShowSubmitImageButton){
            ...
            submitImageButton = new ImageView(activity);
            submitImageButton.setLayoutParams(submitParams);
            submitImageButton.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            submitImageButton.setPadding(padding, 0, padding, 0);
            if (submitDrawable!=0) {
                submitImageButton.setImageResource(submitDrawable);
            }else {
                submitImageButton.setImageResource(R.drawable.icon_submit);
            }
            ...
            topButtonLayout.addView(submitImageButton);
        }
