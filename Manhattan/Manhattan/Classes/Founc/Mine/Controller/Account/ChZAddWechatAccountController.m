//
//  ChZAddWechatAccountController.m
//  FuturePurse
//
...
@interface ChZAddWechatAccountController ()
...
@implementation ChZAddWechatAccountController
...
- (IBAction)saveAction:(id)sender {
    ...
    ChZ_MBMsg(nil)
    ChZ_Weak
    [ChZAccountRequest requestSubmitWechatPayAccount:account qrcode:imgbase64 name:name successBlock:^(id dataSource) {
        ChZ_Strong
