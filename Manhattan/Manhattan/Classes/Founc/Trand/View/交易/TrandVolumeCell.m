...
-(void)reloadLeftCellWithDic:(NSDictionary *)dic{
    ...
    self.muchLable.text = [NSString stringWithFormat:@"%.4f",[[dic objectForKey:@"much"] floatValue]];
    self.sumLable.text = [NSString stringWithFormat:@"%.4f",[[dic objectForKey:@"volume"] floatValue]];
}
