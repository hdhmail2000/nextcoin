...
//颜色背景系列
#define  WhiteBackgroundColor //DarkBackgroundColor
...
#else
//白色背景系列
#define BackgroundColor bgColor
#define CoordinateDisPlayLabelColor [UIColor blackColor]
#define GrateLineColor [UIColor lightGrayColor] //[UIColor colorWithRed:(235/255.0f) green:(237/255.0f) blue:(240/255.0f) alpha:1]
