...
-(void)reloadCellWithModel:(XHHC2CMyReleaseModel *)model{
    ...
    self.hadProfitLable.text = [NSString stringWithFormat:@"%.4f",[model.success_total floatValue]];
