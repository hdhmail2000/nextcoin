...
@property (weak, nonatomic) IBOutlet UITextField *googleCode;
...
- (void)viewDidLoad {
    ...
    [_googleCode configPlaceholderWithFont:[UIFont systemFontOfSize:16.0] textColor:PlaceholderColor];
...
-(void)updateLoginPsw{
    ...
    [XHHSafeCenterRequest requestUpdatePassword:self.currPw.text
                                       password:self.nPw.text
                                        msgCode:nil
                                     googleCode:self.googleCode.text
                                     cardNumber:nil
                                           type:@"0"
