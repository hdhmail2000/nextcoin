    ...
    BitDate = function(option, callback) {
        ...
        this.FN = function() {
            ...
            _this.DrawWrap = function() {
                ...
                _CAL.Html.output += ' <span class="input cal_out_date">' + _this.OP.lang[0] + '</span><span class="input cal_out_time">' + _this.OP.lang[1] + '</span><span class="button cal_out_btn">' + '确定' + "</span>",
