...
//			}
	...
	public boolean updateVirtualCapital(Integer recordId, Integer adminId, BigDecimal amount, int addressNum,
		...
		if (addressNum > 0) {
			...
			// 转入钱包信息
			UserCoinWallet virtualwalletTo = userCoinWalletMapper.selectByUidAndCoinLock(userVirtualAddress.getFuid(), fcoinid);
	...
	@Transactional(isolation = Isolation.REPEATABLE_READ, propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
	public boolean updateVirtualCapital(Integer recordId, Integer adminId, BigDecimal amount, int addressNum,
										CoinDriver coinDriver,BigDecimal networkFee) throws BCException {
...
//			}
	 ...
	 * @param end 结束时间
	 * @return 总金额
	 * @see com.qkwl.common.rpc.admin.IAdminUserCapitalService#selectWalletTotalAmount(Integer, Integer, Date, Date)
	 */
	@Override
	 ...
	 * @param end 结束时间
	 * @return 总金额
	 * @see com.qkwl.common.rpc.admin.IAdminUserCapitalService#selectVirtualWalletTotalAmount(Integer, Integer, Integer, Date, Date)
	 */
	@Override
