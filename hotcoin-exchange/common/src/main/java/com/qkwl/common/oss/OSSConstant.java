...
public class OSSConstant {
     ...
     * OSS基础配置
     */
    public static final String ACCESS_ID = "LTAIstodqiF1WIiq";
    public static final String ACCESS_KEY = "oNnb2xKdLJWTySGNaHOymEhw47xtyb";
    public static final String OSS_ENDPOINT ="http://oss-ap-southeast-1.aliyuncs.com";

    /**
     * BUCKET配置
     */
    public static final String BUCKET_BASE = "biex-web";
