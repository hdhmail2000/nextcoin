...
<head>
    ...
    <meta content="POSCMS" name="software" />
    <meta content="成都天睿信息技术有限公司版权所有" name="copyright" />
        ...
        $(function(){
            ...
            $("#sitelist li").click(function(){
                ...
                art.dialog.confirm("<font color=red><b><?php echo fc_lang('是否要切换站点？'); ?></b></font>", function(){
                    ...
                    dr_tips('<?php echo fc_lang('正在切换之中...'); ?>', 3, 1);
                    var url = '<?php echo dr_url('site/select'); ?>&id='+id;
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        ...
                        <li><a href="<?php echo dr_url('home/dbcache'); ?>" target="right"><i class="fa fa-database"></i> <?php echo fc_lang('更新结构'); ?></a></li>
                        <li><a href="<?php echo dr_url('home/cache'); ?>" target="right"><i class="fa fa-refresh"></i> <?php echo fc_lang('更新全站'); ?></a></li>
                        <li class="divider"> </li>
                        <li><a href="http://www.phpkaiyuancms.com" target="_blank"><i class="fa fa-cloud"></i> <?php echo fc_lang('程序官网'); ?></a></li>
                        <li><a href="http://help.poscms.net" target="_blank"><i class="fa fa-book"></i> <?php echo fc_lang('程序帮助'); ?></a></li>
    ...
    <div class="page-sidebar-wrapper">
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <div class="sidebar-search-wrapper">
                <form style="margin:10px 18px;" class="sidebar-search" action="http://www.phpkaiyuancms.com/index.php" method="get" target="_blank">
