            ...
            <div class="col-xs-9 financial-data financial-data-bg account-data">
                ...
                <div class="col-xs-12 account-table">
                    <table class="col-xs-12">
                        ...
                        <?php if (is_array($locklist)) { $count=count($locklist);foreach ($locklist as $item) { ?>
                        <tr class="account-table-item">
                            <td><?php echo $item['short_name']; ?></td>
                            <td><?php echo sprintf("%.8f",$item['total']); ?></td>
                            <td><?php echo $item['title']; ?></td>
                            <td><?php echo $item['unlock_level']; ?>/<?php echo $item['rule_level']; ?></td>
                            <td><?php echo date("Y-m-d",$item['time']); ?></td>
                        </tr>
                        <?php } }  if (is_array($unlocklist)) { $count=count($unlocklist);foreach ($unlocklist as $item) { ?>
                        <tr class="account-table-item">
                            <td><?php echo $item['short_name']; ?></td>
                            <td><?php echo sprintf("%.8f",$item['total']); ?></td>
                            <td><?php echo $item['title']; ?></td>
