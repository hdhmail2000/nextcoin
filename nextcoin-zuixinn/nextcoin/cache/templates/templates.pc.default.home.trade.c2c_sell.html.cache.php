                            	...
                            	<tbody>
                            	    ...
                            	    <tr class="merchandise-table-tr">
                            	        ...
                            	        <td style="text-align: center;">
                            	            <a href="###" class="btn  btn-sty" onclick="_show($(this))">出售</a>
                                                ...
                                                <div class="col-xs-12 mall-form">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <div class="left mall-form-data">
                                                            <label for="">
                                                                <input type="text" id="pp_<?php echo $v['id']; ?>" oninput="formatMoneyWith6digts2(this);trade_fanwei($(this),<?php echo $v['min_value']; ?>,<?php echo $v['max_value']; ?>,<?php echo $v['order_volume']; ?>,<?php echo $v['order_price']; ?>,'p_<?php echo $v['id']; ?>');" placeholder="请输入出售数量" style="padding-right: 52px;"/>
                                                    ...
                                                    <div class="col-xs-12 mall-list-wrap">
                                                        ...
                                                        <div class="right mall-list-btn">
                                                            ...
                                                            <a href="###" onclick="trade_sell('pp_<?php echo $v['id']; ?>','p_<?php echo $v['id']; ?>','psw_<?php echo $v['id']; ?>','trade_<?php echo $v['id']; ?>');" class="btn btn-danger">出售</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php if ($fn_include = $this->_include("footer.html", "/")) include($fn_include); ?>
        ...
        <script type="text/javascript">
               ...
               function trade_sell(volume_id,price_id,psw_id,trade_id){
               		if($("#"+volume_id).val() == "" || $("#"+volume_id).val() == 0 || $("#"+volume_id).val() == null
               		  ...
               		  || $("#"+psw_id).val() == "" || $("#"+psw_id).val() == 0 || $("#"+psw_id).val() == null){
               			...
               			$.ajax({
               				type:"post",
               				url:"/index.php?s=trade&c=home&m=trade_sell",
               				data:{deal_psw:deal_psw,volume:volume,price:price,trade_id:trade_id1},
               				dataType:"json",
               				success:function(data){
               					if(data.code == 1){
               						layer.msg(data.msg);
               						window.location.href = "/index.php?s=trade&c=home&m=sellOrder&orderId="+data.data;
               					} else {
        ...
        <script type="text/javascript">
			...
			if(pagesize){
				for(var i=1;i<=pagesize;i++){
					if(page == i){
						str += '<li><a href="/index.php?s=trade&c=home&m=c2cSell&id=<?php echo $id; ?>&page='+ i + '"' +' class="active">'+ i +'</a></li>';
					} else {
						str += '<li><a href="/index.php?s=trade&c=home&m=c2cSell&id=<?php echo $id; ?>&page='+ i + '"' +'>'+ i +'</a></li>';
					}
				}
				$("#pages").html(str);
			}
