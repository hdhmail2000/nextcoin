...
<div class="header header-shadow quites-header clearfix">
            ...
            <div class="navbar">
                <div class="navbar-list">
                    ...
                    <!--</div>-->
                    <div class="navbar-list-item">
				        <a id="top_help" href="/index.php?s=trade" <?php if ($_GET['s']=='trade') { ?>class="active"<?php } ?>><?php echo $head['Currency_Transaction']; ?></a>
				    </div>
                    <!--<div class="navbar-list-item">-->
                ...
                <div class="navbar-loging" style="top: 0px;">
                    ...
                    <?php } else { ?>
                        ...
                        <span class="navbar-loging-text">
                            ...
                            </strong><?php echo $head['hi']; ?>, <?php echo $USERNAME; ?>
                            ...
                            <!--<div class="my-box" style="background: #22242E;">-->
                            	...
                            	<!--<?php } ?></strong></h2>-->
                                    ...
                                    <!--</div>-->
                                    <!--<a href="/index.php?s=exc&c=securityController" class="right my-box-header-btn"><?php echo $head['setup']; ?></a>-->
                                <!--</div>-->
