        ...
        'menu' => array(
            array(
                ...
                'menu' => array(
                    ...
                    array(
                        'name' => '会员设置',
                        'uri' => 'admin/member_setting/index',
                        'icon' => 'fa fa-cog',
                    ),
                    array(
                        'name' => '网银接口',
                        'uri' => 'admin/member_setting/pay',
                        'icon' => 'fa fa-rmb',
                    ),
                    array(
                        'name' => '多语言设置',
            ...
            array(
                ...
                'menu' => array(
                    ...
                    array(
                        'name' => '会员权限',
                        'uri' => 'admin/member_setting/permission',
                        'icon' => 'fa fa-users',
                    ),
                    array(
                        'name' => '管理员管理',
        ...
        'menu' => array(
            array(
                ...
                'menu' => array(
                    ...
                    array(
                        'name' => '会员模型',
                        'uri' => 'admin/member_group/index',
                        'icon' => 'fa fa-users',
                    ),
                    array(
                        'name' => '财务流水',
                        'uri' => 'admin/member_pay/index',
                        'icon' => 'fa fa-calculator',
                    ),
                    array(
                        'name' => '会员菜单',
                        'uri' => 'admin/member_menu/index',
                        'icon' => 'fa fa-list',
                    ),
                    array(
                        'name' => '快捷登录',
                        'uri' => 'admin/member_setting/oauth',
                        'icon' => 'fa fa-weibo',
                    ),
                    array(
                        'name' => '自定义字段',
