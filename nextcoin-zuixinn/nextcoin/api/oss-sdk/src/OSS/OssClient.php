...
require_once __DIR__ . '/Core/MimeTypes.php';
require_once __DIR__ . '/Core/OssException.php';

require_once __DIR__ . '/Http/RequestCore.php';
require_once __DIR__ . '/Http/RequestCore_Exception.php';
require_once __DIR__ . '/Http/ResponseCore.php';

require_once __DIR__ . '/Model/CorsConfig.php';
require_once __DIR__ . '/Model/CnameConfig.php';
require_once __DIR__ . '/Model/LoggingConfig.php';
require_once __DIR__ . '/Model/LiveChannelConfig.php';
require_once __DIR__ . '/Model/LiveChannelInfo.php';
require_once __DIR__ . '/Model/LiveChannelListInfo.php';

require_once __DIR__ . '/Result/AclResult.php';
require_once __DIR__ . '/Result/BodyResult.php';
require_once __DIR__ . '/Result/GetCorsResult.php';
require_once __DIR__ . '/Result/GetLifecycleResult.php';
require_once __DIR__ . '/Result/GetLocationResult.php';
require_once __DIR__ . '/Result/GetLoggingResult.php';
require_once __DIR__ . '/Result/GetRefererResult.php';
require_once __DIR__ . '/Result/GetStorageCapacityResult.php';
require_once __DIR__ . '/Result/GetWebsiteResult.php';
require_once __DIR__ . '/Result/GetCnameResult.php';
require_once __DIR__ . '/Result/HeaderResult.php';
require_once __DIR__ . '/Result/InitiateMultipartUploadResult.php';
require_once __DIR__ . '/Result/ListBucketsResult.php';
require_once __DIR__ . '/Result/ListMultipartUploadResult.php';
require_once __DIR__ . '/Model/ListMultipartUploadInfo.php';
require_once __DIR__ . '/Result/ListObjectsResult.php';
require_once __DIR__ . '/Result/ListPartsResult.php';
require_once __DIR__ . '/Result/PutSetDeleteResult.php';

require_once __DIR__ . '/Result/DeleteObjectsResult.php';
require_once __DIR__ . '/Result/CopyObjectResult.php';
require_once __DIR__ . '/Result/CallbackResult.php';
require_once __DIR__ . '/Result/ExistResult.php';
require_once __DIR__ . '/Result/PutLiveChannelResult.php';
require_once __DIR__ . '/Result/GetLiveChannelHistoryResult.php';
require_once __DIR__ . '/Result/GetLiveChannelInfoResult.php';
require_once __DIR__ . '/Result/GetLiveChannelStatusResult.php';
require_once __DIR__ . '/Result/ListLiveChannelResult.php';
require_once __DIR__ . '/Result/AppendResult.php';

require_once __DIR__ . '/Model/ObjectListInfo.php';
require_once __DIR__ . '/Result/SymlinkResult.php';
require_once __DIR__ . '/Result/UploadPartResult.php';
require_once __DIR__ . '/Model/BucketListInfo.php';
require_once __DIR__ . '/Model/LifecycleConfig.php';
require_once __DIR__ . '/Model/RefererConfig.php';
require_once __DIR__ . '/Model/WebsiteConfig.php';

require_once __DIR__ . '/Core/OssUtil.php';
require_once __DIR__ . '/Model/ListPartsInfo.php';
