var finances = {
    submit: function (ele) {
        ...
        var url = "/index.php?s=exc&c=financeController&m=submit";
        var param = {
            symbol: symbol,
            type: finType,
            count: finCount,
    ...
    getFinances: function (ele) {
        var url = "/index.php?s=exc&c=financeController&m=clacCount";
        var param = {
            symbol: $(ele).val(),
        };
        var callback = function (result) {
            ...
            $("#btcbalance").val(util.numFormat(result.data.total));
            $("#assettotal").html( util.numFormat(result.data.total));
