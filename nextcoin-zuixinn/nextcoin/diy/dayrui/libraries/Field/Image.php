...
class F_Image extends A_Field {
	...
	public function insert_value($field) {
		...
		// 第一张作为缩略图
		if (isset($field['setting']['option']['autothumb']) && $field['setting']['option']['autothumb']
            && isset($_POST['data']['thumb']) && !$_POST['data']['thumb'] && isset($rt[0]) && $rt[0]) {
            $this->ci->data[1]['thumb'] = $rt[0];
		}

		$this->ci->data[$field['ismain']][$field['fieldname']] = dr_array2string($rt);
	}
