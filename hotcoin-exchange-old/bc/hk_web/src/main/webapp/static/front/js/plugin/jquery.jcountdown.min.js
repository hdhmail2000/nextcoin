    ...
    jCountdown: function() {
        var B = function(b) {
          ...
          , y = function() {
            ...
            this.checkTime = function(b) {
                ...
                var c = this.timeFormat(this._time, this._days.length, this._hours.length, this._minutes.length, this._seconds.length).split("");
                if (!isNaN(this._time)) {
                    for (a = 0; a < this._days.length; a++) {
        ...
        if (0 < arguments.length) {
            ...
            if (1 == arguments.length && "object" == typeof arguments[0]) {
                ...
                q.data("countdown", m),
                m = v()) : m = void 0;
                var j = parseInt(11 , 10)
                  , y = "string" == typeof e.timeText ? e.timeText : ""
                  , y1="number" == typeof e.timeNumber ? e.timeNumber : 0
                ...
                u && !(10 > j) && (reflectionObject = g.clone(),
                ...
                f.width(n * d),
                f.height(p * d),
                8 >= j ? k.css("zoom", d) : (k.css("transform", l).css("-moz-transform", l).css("-webkit-transform", l).css("-o-transform", l).css("-ms-transform", l),
