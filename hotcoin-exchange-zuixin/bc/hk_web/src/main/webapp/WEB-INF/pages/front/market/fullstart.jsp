...
<title></title>
<link rel="stylesheet" href="${staticurl }/front/css/fullkline/fullScreenKline.css" type="text/css"></link>
</head>
<!-- Chart Container -->
...
<script type="text/javascript" src="${staticurl }/front/js/fullkline/jquery.mousewheel.js"></script>
<script type="text/javascript" src="${staticurl }/front/js/fullkline/fullKilne.js"></script>
<script type="text/javascript">
	var lan = '${requestScope.localeStr}';
		if (lan == 'zh_CN') {
			lan = "zh-cn";
		} else if (lan == 'zh_TW') {
			lan = "zh-tw";
	...
	_set_current_language(lan);
	_setCaptureMouseWheelDirectly(false);	
	_set_current_coinshortName('${shortname}');
	_set_current_coin('${symbol}');
	_set_current_contract_unit('${symbol}');
	onPushingStarted();
</script>
</html>
