...
public class ETCController extends JsonBaseController {
    ...
    public String etcRecharge(
        ...
        logger.info("etcRecharge : " + txhash + " : "+ to + " : "+ value + " : "+ sign + " : "+ symbol);
        //判断参数
        ...
        if (coinType == null) {
            logger.error("etcRecharge : coinType == null");
        ...
        if (baseCoinType == null) {
            logger.error("etcRecharge : baseCoinType == null");
            return ReturnMsg(10001, "服务器错误");
        }
        //验证签名
        try {
            ...
            CoinDriver coinDriver = new CoinDriverFactory.Builder(coinType.getCoinType(), coinType.getIp(), coinType.getPort())
                    ...
                    .getDriver();
            if (coinDriver == null) {
                logger.error("etcRecharge : coinDriver == null");
                return ReturnMsg(10001, "服务器错误");
            }
            signVerify = coinDriver.getETCSHA3(signVerify);
            if (!signVerify.equals(sign)) {
                logger.error("etcRecharge : signVerify error");
        ...
        try {
            ...
            if (!result.getSuccess()) {
                logger.error("etcRecharge : createCoinOperationOrder error");
        ...
        logger.info("etcRecharge : success");
