...
import com.qkwl.web.proxy.FetchData;
...
public class FrontRealJsonController extends JsonBaseController {
    ...
    public ReturnResult MarketJson(
        ...
        // 深度
        jsonObject.put("buys", autoMarket.getBuyDepthJson(tradeType.getId(), buysellcount));
        jsonObject.put("sells", autoMarket.getSellDepthJson(tradeType.getId(), buysellcount));
        // 最新成交
