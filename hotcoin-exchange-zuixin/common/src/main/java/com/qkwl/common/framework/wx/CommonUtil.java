...
import com.qkwl.common.dto.wx.po.Token;
...
public class CommonUtil {
	...
	// 凭证获取（GET）
	public final static String token_url = "https://huobi.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=APPID&secret=APPSECRET";
