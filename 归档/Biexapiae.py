...
if __name__ == '__main__':
    ...
    if nowTime in range(1, 4):
        ...
        amount = round(random.uniform(250, 400), 1)
    elif nowTime in range(13, 16):
        amount = round(random.uniform(200, 300), 1)
    ...
    if round_type == 2:
        buyOne = b.buy("ae_cnyt", price, amount)
        if buyOne.get('status') == 'ok':
            sellOne = b.sell("ae_cnyt", price, amount)
