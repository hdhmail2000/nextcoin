...
if __name__ == '__main__':
    ...
    accountInfo = b.accountInfo("wkb_cnyt")
    print accountInfo
    print "================================================================================"
    tickers = b.tickers("wkb_cnyt")
    print tickers
    price = round(random.uniform(tickers.get('buyOne'), tickers.get('sellOne')), 3)
    ...
    if nowTime in range(1, 4):
        ...
        amount = round(random.uniform(200, 400), 1)
    elif nowTime in range(13, 16):
        amount = round(random.uniform(400, 600), 1)
    elif nowTime in range(18, 22):
        amount = round(random.uniform(10, 200), 1)
    else:
        amount = round(random.uniform(10, 300), 1)
    round = round(random.uniform(1, 2), 0)
    if round == 2.0:
        buyOne = b.buy("wkb_cnyt", price, amount)
        if buyOne.get('status') == 'ok':
            sellOne = b.sell("wkb_cnyt", price, amount)
    ...
    # entrust_data = b.entrust(1,'wkb_cnyt')
    # entrust_data = b.entrust(1,'ae_cnyt')

    # print entrust_data['code']
    # tt =  entrust_data['data']['entrutsCur']
    #print(tt[0]['id'])
    b.cancelAllEntrust('wkb_cnyt')