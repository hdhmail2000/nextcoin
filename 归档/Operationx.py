    ...
    def get_latest_price(self, check_type, sourceURL):
        ...
        if resp.status_code == 200:
            if check_type == 'eth_cnyt':
                ...
                latest_price = json.loads(resp.text).encode('utf-8')
...
if __name__ == '__main__':
    ...
    check_types = ['eth_cnyt', 'wkb_cnyt', 'sc_cnyt','ae_cnyt']
    ...
    for check_type in check_types:
        if check_type == 'eth_cnyt':
            ...
            minimum_limit = 0.00003  # xdag波动区间
            maximum_limit = 0.001
            min_count = 80  # xdag数量区间及精度
            max_count = 200
            count_float = 0
